#!/usr/bin/env python3
"""
Simple GUI for triggering FL Studio piano roll scripts via F3+B keyboard shortcut.

This is useful for triggering piano roll scripts like BeginLLMInteraction
that are bound to the F3+B key combination in FL Studio.
"""
...
class F3TriggerUI(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle("FL Studio Script Trigger")
        self.resize(300, 200)
        ...
        # Title
        title = QLabel("FL Studio Script Trigger")
        ...
        # Trigger button
        self.trigger_btn = QPushButton("Trigger F3+B")
    ...
    def trigger_script(self):
        """Send F3+B keystroke to trigger FL Studio script."""
        try:
